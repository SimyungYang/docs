...
\<figure>\<img src="https://docs.databricks.com/aws/en/assets/images/workspace-aws-ce9af6e59d08faac258c00cb4a6b103d.png" alt="Databricks Workspace 메인 화면 (AWS)">\<figcaption>Databricks Workspace 메인 화면 — 왼쪽 사이드바와 메인 콘텐츠 영역으로 구성됩니다</figcaption></figure>
...
\<figure>\<img src="https://docs.databricks.com/aws/en/assets/images/new-editor-frame-tools-6026302173fe8cf5c91e6899efc58f2a.png" alt="Databricks SQL Editor 인터페이스">\<figcaption>SQL Editor — 왼쪽 스키마 브라우저, 중앙 쿼리 편집 영역, 하단 결과 패널로 구성됩니다</figcaption></figure>
...
\<figure>\<img src="https://docs.databricks.com/aws/en/assets/images/simple-form-ca9c44423abe9f43bc9df4c75d9cb7c9.png" alt="Databricks Compute 생성 화면">\<figcaption>Compute 생성 화면 — 클러스터 이름, 크기, 런타임 버전 등을 설정합니다</figcaption></figure>
...
\<figure>\<img src="https://docs.databricks.com/aws/en/assets/images/example-job-overview-3afc40004602e65c871bd67edfa87f9b.png" alt="Databricks Jobs 화면">\<figcaption>Jobs 화면 — 4개 Task로 구성된 Job과 일일 스케줄 트리거 예시</figcaption></figure>
...
\<figure>\<img src="https://docs.databricks.com/aws/en/assets/images/sample-lakeview-dash-5f9212753287d145e9bca0355aaa9ac6.png" alt="Databricks AI/BI Dashboard">\<figcaption>AI/BI Dashboard (Lakeview) — 차트, 표, 필터를 조합한 대시보드 예시</figcaption></figure>
...
\<figure>\<img src="https://docs.databricks.com/aws/en/assets/images/catalog-explorer-grant-0393471630c826976deb4b5ba0b5bfd9.png" alt="Databricks Catalog Explorer">\<figcaption>Catalog Explorer — 카탈로그/스키마/테이블을 탐색하고 권한을 관리합니다</figcaption></figure>
...
\<figure>\<img src="https://assets.docs.databricks.com/_static/images/notebooks/notebook-demo.gif" alt="Databricks Notebook 인터페이스">\<figcaption>Notebook 인터페이스 — 셀 기반 코드 작성, 실행, 결과 확인을 한 화면에서 수행합니다</figcaption></figure>
