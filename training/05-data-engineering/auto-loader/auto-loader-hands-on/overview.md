...
| 실습 | 파일 | 핵심 주제 |
|------|------|----------|
| **실습 1** | [사전 준비와 CSV 수집](setup-and-csv) | 환경 구성, CSV 증분 수집, Checkpoint 이해 |
| **실습 2** | [JSON 수집과 스키마 진화](json-and-schema-evolution) | JSON 수집, 스키마 진화, 중첩 구조 처리 |
| **실습 3** | [SDP와 Auto Loader 통합](sdp-integration) | `read_files()`, Medallion 파이프라인, 데이터 품질 |
| **실습 4** | [데이터 검증과 트러블슈팅](validation-and-troubleshooting) | 품질 리포트, 체크포인트 리셋, 에러 해결 |
...
- [Auto Loader란?](../what-is-auto-loader) — Auto Loader의 개념, 파일 감지 모드, 스키마 추론/진화
- [Auto Loader 주요 옵션](../auto-loader-options) — `cloudFiles.*` 옵션 상세
