...
- [실습 1](setup-and-csv) 과 [실습 2](json-and-schema-evolution) 에서 생성한 샘플 데이터가 존재해야 합니다.
...
- [데이터 검증과 트러블슈팅](validation-and-troubleshooting) — 파이프라인 전체의 데이터 품질을 검증하고 장애 상황을 해결합니다.
