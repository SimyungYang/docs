...
| 순서 | 문서 | 내용 |
|------|------|------|
| 1 | [Apache Spark 기초](spark-basics.md) | 분산 처리의 개념, Driver와 Executor, DataFrame을 설명합니다 |
| 2 | [클러스터 종류](cluster-types.md) | All-Purpose, Job, Serverless 클러스터를 비교합니다 |
| 3 | [클러스터 설정](cluster-configuration.md) | 노드 타입, 오토스케일링, Spot 인스턴스, Photon을 다룹니다 |
| 4 | [SQL Warehouse](sql-warehouse.md) | SQL Warehouse의 구성, 사이즈 선택, BI 도구 연결을 안내합니다 |
| 5 | [Serverless 컴퓨트](serverless-compute.md) | 동작 원리, 비용 모델, 적합한 워크로드를 설명합니다 |
