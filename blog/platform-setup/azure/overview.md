...
| 2 | [사전 준비](prerequisites) | 구독, 권한, 리전 |
| 3 | [Resource Group 생성](resource-group) | 리소스 그룹 구성 |
| 4 | [Virtual Network (VNet) 생성](vnet) | VNet, Subnet, NSG 위임 |
| 5 | [Access Connector 생성](access-connector) | Managed Identity 기반 스토리지 접근 |
| 6 | [Storage Account 생성 (ADLS Gen2)](storage-account) | Unity Catalog용 스토리지 |
| 7 | [Workspace 배포](workspace) | Azure Portal에서 Workspace 프로비저닝 |
| 8 | [Backend Private Link](privatelink) | Private Endpoint + DNS Zone |
| 9 | [Unity Catalog](unity-catalog) | Metastore + Catalog & Schema |
