...
|------|------|----------|----------|--------|
| **Track A** | 노트북 직접 실행 | 없음 | 코드를 한 줄씩 읽으며 원리를 이해하고 싶은 분 | [01. Foundation](01-foundation) ~ [07. Apps & Lakebase](07-apps-lakebase) |
| **Track B** | Claude Code + AI Dev Kit | Python 3.10+, Claude Code | AI 코딩 도구로 생산성 향상을 체험하고 싶은 분 | [PROMPT\_GUIDE.md](notebooks/track-b-ai-guided/PROMPT_GUIDE) |
| **Track C** | Genie Code (Databricks 내장) | 없음 | 별도 설치 없이 Databricks 안에서 AI 코딩을 체험하고 싶은 분 | [GENIE\_CODE\_GUIDE.md](notebooks/track-c-genie-code/GENIE_CODE_GUIDE) |

### Track A — 노트북 직접 실행

노트북을 순서대로 열어 Run All을 실행합니다. 코드를 한 줄씩 읽으며 동작 원리를 이해하고 싶은 분에게 추천합니다. 추가 설치가 필요 없습니다.

> **진행 순서**: [01. Foundation](01-foundation) -> [02. Data Engineering](02-data-engineering) -> [03. Analytics](03-analytics) -> [04. Streaming](04-streaming) -> [05. ML](05-ml) -> [06. GenAI](06-genai) -> [07. Apps & Lakebase](07-apps-lakebase)
...
> **가이드**: [PROMPT\_GUIDE.md](notebooks/track-b-ai-guided/PROMPT_GUIDE) | [상세 프롬프트](notebooks/track-b-ai-guided/PROMPT_DETAILED)

### Track C — Genie Code (Databricks 내장)

Databricks 노트북에서 `Cmd+I`로 Genie Code를 호출하여 자연어로 코드를 생성합니다. 별도 설치 없이 즉시 AI 코딩을 체험할 수 있습니다.

> **가이드**: [GENIE\_CODE\_GUIDE.md](notebooks/track-c-genie-code/GENIE_CODE_GUIDE)
