...
| 페이지 | 내용 |
|--------|------|
| [기본 기법](basics) | Zero-shot, Few-shot, CoT 비교 + System Prompt 5패턴 + 실전 템플릿 3종 |
| [고급 기법](advanced) | ReAct, ToT, Self-Consistency, Structured Output, Prompt Chaining + 최적화 기법 |
| [한국어 최적화](korean) | 한국어 프롬프트 최적화 + 디버깅 전략 |
| [보안](security) | Prompt Injection 공격 유형과 방어 기법 |
| [실전 활용](practical) | 업종별 패턴, Databricks 활용, 전문가 노하우, FAQ, 연습문제 |
