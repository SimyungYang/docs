...
| 페이지 | 내용 |
|--------|------|
| [규칙 기반 + 통계적 NLP](rule-statistical) | 규칙 기반 NLP (1950~1990) + 통계적 NLP (1990~2000) — N-gram, TF-IDF, HMM |
| [단어 임베딩 혁명](embeddings) | 단어 임베딩 (2003~2014) — NNLM, Word2Vec, GloVe, BPE |
| [순환 신경망 시대](rnn-lstm) | RNN, LSTM, GRU, TextCNN (2014~2017) |
| [Seq2Seq, Attention, Transformer](attention-transformer) | 정보 병목 해결, Bahdanau Attention, Self-Attention, Transformer 탄생 (2014~2017) |
| [사전학습 시대](pretrain-era) | ULMFiT, BERT, GPT, Scaling Laws, RLHF, 세 계보 (2018~) |
| [전체 흐름 요약 + 인사이트](insights) | 기술 발전 패턴(S-curve), 미해결 과제, 고객 FAQ, 연습문제, 참고자료 |
