...
| 페이지 | 설명 |
|--------|------|
| [사용법](usage) | Chat/Agent 모드, 인라인 제안, Quick Fix, Slash 명령어 상세 사용법 |
| [활용 시나리오](scenarios) | 데이터 사이언스, DE, 대시보드, GenAI 시나리오별 예시 |
| [MCP 연동](mcp) | MCP 개요, 서버 설정, Genie Code에서 MCP 활용 |
| [Space vs Code 비교](comparison) | Genie Space와 Genie Code의 상세 비교 |
