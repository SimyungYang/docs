...
`--profile`, `--local`, 특정 스킬 이름, `--mlflow-version` 등을 필요에 따라 조합해서 사용하세요. `./databricks-skills/install_skills.sh --help` 또는 [databricks-skills/README.md](https://github.com/databricks-solutions/ai-dev-kit/blob/main/databricks-skills/README)를 참조하세요.
...
이 프로젝트의 소스는 [Databricks License](https://databricks.com/db-license-source)에 따라 제공됩니다. 자세한 내용은 [LICENSE.md](https://github.com/databricks-solutions/ai-dev-kit/blob/main/LICENSE)를 참조하세요.
