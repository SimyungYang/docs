...
**해결**: 작업마다 새 대화를 시작하세요. → [프롬프트 5대 원칙 — 원칙 1](prompt-principles#원칙-1-작업마다-새-대화-context-isolation) 참조
...
**해결**: **"Allow in this thread"만 사용**. → [시작하기 — 승인 옵션](getting-started#승인-옵션-중요) 참조
...
- **[보안 제한사항](security-limitations)** — 뭐가 되고 뭐가 안 되는지 미리 알면 삽질을 피할 수 있습니다.
