...
| 주제 | 내용 |
|------|------|
| [Genie Code란?](what-is-genie-code) | 일반 코딩 AI와 뭐가 다른지 |
| [시작하기](getting-started) | 모드 선택, 단축키, 슬래시 명령어 |
| [프롬프트 5대 원칙](prompt-principles) | 잘 쓰는 프롬프트 vs 못 쓰는 프롬프트 |
| [꿀팁 모음](tips-and-tricks) | 현업에서 바로 쓰는 실전 팁 20가지 |
| [상황별 프롬프트 템플릿](prompt-templates) | 복붙해서 바로 쓸 수 있는 프롬프트 |
| [Custom Instructions](custom-instructions) | 팀 규칙을 Genie Code에 심는 방법 |
| [자주 하는 실수](common-mistakes) | 시간 낭비를 피하는 안티패턴 |
| [보안 제한사항](security-limitations) | 뭐가 되고 뭐가 안 되는지 (Serverless, 권한, Rate Limit) |
| [내장 기능 둘러보기](built-in-features) | Skills, MCP, 슬래시 명령어 확인법 |
| [스크린샷 가이드](screenshot-guide) | 교육 자료 준비용 캡처 체크리스트 |
