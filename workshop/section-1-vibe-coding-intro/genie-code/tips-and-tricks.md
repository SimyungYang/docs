---
title: "꿀팁 모음 — 현업에서 바로 쓰는 실전 팁 20가지"
---
...
5개만 등록해도 정확도가 크게 올라갑니다. → [상세 가이드](../../section-4-smart-tv-handson/04-dashboard-genie)
...
- **[상황별 프롬프트 템플릿](prompt-templates)** — 복붙해서 바로 쓸 수 있는 프롬프트 모음입니다.
