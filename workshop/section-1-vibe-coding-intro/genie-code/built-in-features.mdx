---
title: "내장 기능 둘러보기 — Skills, MCP, 숨겨진 기능"
---
...
> 전체 명령어 목록과 사용법은 [시작하기 — 슬래시 명령어](getting-started#슬래시-명령어)를 참조하세요.
...
> 상세 구성 방법, 도구 선택 전략, 프로필별 추천은 [Section 3: Genie Code + AI Dev Kit 연결](../../section-3-ai-tools-setup/genie-code-aidevkit)을 참조하세요.
...
- **[Section 2: AI Builder App 배포](../../section-2-ai-builder-app/README)** — AI Dev Kit MCP 서버를 Databricks App으로 배포합니다.
