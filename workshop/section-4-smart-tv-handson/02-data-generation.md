...
> [01. 환경 설정](01-setup)에서 카탈로그/스키마를 이미 생성했다면 이 단계는 건너뛰세요.
...
- **[03. SDP 파이프라인 — 데이터 품질과 Medallion Architecture](03-sdp-pipeline)** — Bronze→Silver→Gold 변환 + 증분 처리 자동화
- **[04. 대시보드 & Genie Space](04-dashboard-genie)** — AI/BI 대시보드 + Genie Space + 정확도 고도화
