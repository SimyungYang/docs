...
Skills 배포 스크립트(git clone → workspace import)는 **[AI Dev Kit 설치 — Skills 배포](ai-dev-kit-setup#skills-배포-workspace)** 섹션을 참조하세요.
...
>
> **참고**: 이 단계는 [Section 4-04](../section-4-smart-tv-handson/04-dashboard-genie)에서 Genie Space를 생성한 후에 실행하세요.
...
| **"Tool execution failed"** 에러 | 앱 크래시 또는 서비스 프린시펄 권한 문제 | Genie Code Settings → MCP Servers에서 서버 연결 해제 후 다시 추가 | [Section 2 트러블슈팅](../section-2-ai-builder-app/README#mcp-서버-운영-중-문제-genie-code에서-사용-시) 참조 |
...
| **대시보드 생성 중 "Warehouse not accessible"** | 서비스 프린시펄에 SQL Warehouse 권한 없음 | Databricks UI에서 수동 생성 | [Section 2 Step 5](../section-2-ai-builder-app/README) 권한 재부여 |
...
구성이 완료되었으면 **[Section 4: 환경 설정](../section-4-smart-tv-handson/01-setup)**으로 이동하여 실습 환경을 준비합니다.
